...
class ListRemoteViewsFactory(
  ...
  override fun getViewAt(position: Int): RemoteViews {
      ...
      return RemoteViews(context.packageName, R.layout.item_view).apply {
          setTextViewText(R.id.contentTextView, noteItems[position].content)
          ...
          setOnClickFillInIntent(R.id.noteContainer, fillInIntent)
      }
  }
